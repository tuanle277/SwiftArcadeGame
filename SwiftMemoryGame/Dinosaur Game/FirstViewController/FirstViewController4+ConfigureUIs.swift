...
//        self.shadowView.isUserInteractionEnabled = true
        ...
        gradientLayer1.frame = self.rankingBackground.bounds
        self.rankingBackground.layer.insertSublayer(gradientLayer1, at: 0)
        self.rankingBackground.clipsToBounds = true


        self.startGameBackground.layer.cornerRadius = 30
        self.rankingBackground.layer.cornerRadius = 30
